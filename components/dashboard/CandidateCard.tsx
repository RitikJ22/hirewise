...
export default function CandidateCard({ candidate }: CandidateCardProps) {
  ...
  return (
    <motion.div
      ...
      className="w-full"
    >
      <Card className="bg-card border-border hover:border-primary/50 transition-colors h-[480px] flex flex-col">
        ...
        <CardContent className="p-4 space-y-4 flex-1 flex flex-col min-h-0">
          ...
          <div className="flex items-center space-x-3 text-sm text-muted-foreground">
            ...
            <div className="flex items-center space-x-1">
              ...
              <span className="truncate">{candidate.work_availability[0]}</span>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="pl-5 space-y-1">
              {candidate.education.degrees.slice(0, 1).map((degree, index) => (
                <div key={index} className="text-xs text-muted-foreground">
